...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "CITK Library — Library Management System" },
      { name: "description", content: "Modern library system with student ID cards, book catalog, and circulation management." },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/png", href: "/citklogo.png" },
